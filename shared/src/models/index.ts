...
export function initModels(sequelize: Sequelize) {
  ...
  Group.hasMany(Jurisdiction, { foreignKey: "groupId", as: "jurisdictions" });
  Jurisdiction.belongsTo(Group, { foreignKey: "groupId", as: "group" });

  Jurisdiction.hasMany(Zone, { foreignKey: "jurisdictionId", as: "zones" });
  Zone.belongsTo(Jurisdiction, { foreignKey: "jurisdictionId", as: "jurisdiction" });

  Jurisdiction.hasMany(Worker, { foreignKey: "jurisdictionId", as: "workers" });
  Worker.belongsTo(Jurisdiction, { foreignKey: "jurisdictionId", as: "jurisdiction" });

  Jurisdiction.hasMany(Order, { foreignKey: "jurisdictionId", as: "orders" });
  Order.belongsTo(Jurisdiction, { foreignKey: "jurisdictionId", as: "jurisdiction" });

  Jurisdiction.hasMany(DispatchQueue, { foreignKey: "jurisdictionId", as: "dispatchQueueEntries" });
  DispatchQueue.belongsTo(Jurisdiction, { foreignKey: "jurisdictionId", as: "jurisdiction" });

  Worker.belongsToMany(Zone, { through: ZoneWorker, foreignKey: "workerId", otherKey: "zoneId", as: "zones" });
  Zone.belongsToMany(Worker, { through: ZoneWorker, foreignKey: "zoneId", otherKey: "workerId", as: "workers" });

  Worker.hasMany(Schedule, { foreignKey: "workerId", as: "schedules" });
  Schedule.belongsTo(Worker, { foreignKey: "workerId", as: "worker" });

  Order.hasMany(DispatchQueue, { foreignKey: "orderId", as: "dispatchQueueEntries" });
  DispatchQueue.belongsTo(Order, { foreignKey: "orderId", as: "order" });
